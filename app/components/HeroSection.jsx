    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12 my-20">
        <div className="col-span-6 place-self-center place-items-center grid lg:place-items-start">
          ...
          <span className=" lg:text-2xl p-3 mb-6 text-base text-center">
            <p>
              Specializing in building meaningful web products.
            </p>{" "}
            <p>From ideation to deployment, we make your visions a reality.</p>{" "}
            <p className="text-center text-3xl">Passion <em className="text-red-500 font-bold">IS</em> the difference.</p>
          </span>
